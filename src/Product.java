...
//CONSTRUCTOR
    public Product(String codigo, double precio, String nombre, int cantidad) {
        this.codigo = codigo;
        this.precio = precio;
        this.nombre = nombre;
...
System.out.println("*******************************");
    ...
    static void main(String[] args) {
        ...
        //DATA QUEMADA
var producto1 = new Product("P001",40.000,"Teclado Mecanico",10);
var producto2 = new Product("P002",80.000,"Mouse Gamer",20);
var producto3 = new Product("P003",450.000,"Monito LCD 4K",8);
